...
#define RC_PROTO_BIT_IRMP		BIT_ULL(RC_PROTO_IRMP)
...
#endif
#if IS_ENABLED(CONFIG_IR_IRMP_DECODER)
#define __RC_PROTO_IRMP_CODEC RC_PROTO_BIT_IRMP
#else
#define __RC_PROTO_IRMP_CODEC 0
#endif
