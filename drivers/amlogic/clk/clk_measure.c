...
static const char * const sc2_table[] = {
...
static const struct meson_clkmsr_data sc2_data = {
	.clk_table = sc2_table,
	.table_size = ARRAY_SIZE(sc2_table),
	.clk_msr_function = gxbb_clk_util_clk_msr,
};
...
static const struct of_device_id meson_clkmsr_dt_match[] = {
	...
	{	.compatible = "amlogic, sc2-measure", .data = &sc2_data },
	{}
};
