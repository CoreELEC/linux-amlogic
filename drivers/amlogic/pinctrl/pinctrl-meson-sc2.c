/*
 * drivers/amlogic/pinctrl/pinctrl-meson-sc2.c
 *
...
static struct meson_pinctrl_data meson_sc2_periphs_pinctrl_data = {
	...
	.pcf_drv_data	= &meson_sc2_periphs_drive_data,
};
...
static int __init meson_sc2_pinctrl_init(void)
{
...
arch_initcall(meson_sc2_pinctrl_init);
